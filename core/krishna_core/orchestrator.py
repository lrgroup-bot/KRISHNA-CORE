...
class Orchestrator:
    ...
    def _register_shared_actions(self):
        ...
        def design_drift_action(payload,context):
            return self.sudarshan_design.drift.compare(
                payload.get("expected") or {},payload.get("actual") or {},
            )
        ...
        def model_scout_evaluate_action(payload,context):
            ...
            return self.agi.model_scout.evaluate(
                candidate,min_score=float(payload.get("min_score") or 0.55),
            )
