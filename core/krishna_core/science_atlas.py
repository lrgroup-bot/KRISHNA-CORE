...
FIELD_RISHI_MAP = {
    "agricultural and biological sciences": ("parashara","kashyapa","shalihotra","kanada","bharadvaja","gautama","veda-vyasa"),
    ...
    "materials science": ("kanada","nagarjuna","vishwamitra","bharadvaja","gautama","veda-vyasa"),
    "mathematics": ("aryabhata","brahmagupta","bhaskaracharya","madhava","pingala","gautama","veda-vyasa"),
    ...
    "pharmacology, toxicology and pharmaceutics": ("dhanvantari","charaka","sushruta","nagarjuna","kanada","gautama","veda-vyasa"),
    "physics and astronomy": ("kanada","atri","aryabhata","bhaskaracharya","vishwamitra","bharadvaja","gautama","veda-vyasa"),
    ...
    "veterinary": ("shalihotra","kashyapa","sushruta","charaka","gautama","veda-vyasa"),
}
...
KEYWORD_TEAMS = (
    ...
    (("drug discovery","pharmacology","therapeutics","precision medicine","clinical pharmacology"),
     ("dhanvantari","charaka","sushruta","nagarjuna","gautama","veda-vyasa")),
    (("meteorology","weather","hydrology","geology","geophysics","natural hazards"),
     ("varahamihira","atri","kanada","agastya","gautama","veda-vyasa")),
    (("agriculture","soil","crop","agronomy","food systems","irrigation"),
     ("parashara","kashyapa","shalihotra","varahamihira","gautama","veda-vyasa")),
    (("veterinary","animal health","livestock","zoonoses"),
     ("shalihotra","kashyapa","sushruta","charaka","gautama","veda-vyasa")),
    (("economics","supply chain","logistics","operations research","resource allocation"),
     ("chanakya","bhaskaracharya","gautama","vashistha","veda-vyasa")),
    (("civil engineering","structural engineering","infrastructure","geometry","surveying"),
     ("baudhayana","bharadvaja","bhaskaracharya","kanada","gautama","veda-vyasa")),
    (("chemistry","catalysis","electrochemistry","metallurgy","process engineering"),
     ("nagarjuna","kanada","bharadvaja","gautama","veda-vyasa")),
