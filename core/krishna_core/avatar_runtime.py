...
class AvatarRuntime:
    ...
    def apply_performance(self,performance):
        ...
        command=self.set_state(
            ...
            head_tilt=performance.get("head_tilt"),
            neck_motion=performance.get("neck_motion"),
            body_pose=performance.get("body_pose"),
            torso_state=performance.get("torso_state"),
            ...
            breathing_profile=performance.get("breathing_profile"),
            camera_profile=performance.get("camera_profile"),
            scene_profile=performance.get("scene_profile"),
