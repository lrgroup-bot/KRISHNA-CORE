...
Database-backed verified learning remains canonical. Structured project-governance
layers are stored under KRISHNA runtime state, never inside project source trees
unless a separately governed source write is explicitly requested.
"""
    ...
    def learn_verified(self,project,goal,result):
        ...
        if self.root is not None:
            try:
                ...
                self.memory.audit("project_brain","governance_record_failed",f"{project}:{type(exc).__name__}")
