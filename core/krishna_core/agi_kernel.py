...
class AGIKernel:
    ...
    def __init__(self,runtime_root,memory,gyan,verification_engine,reviewer,secure_vault=None):
        ...
        self.vishvakarma_learning=VishvakarmaLearning(self.root/"vishvakarma"/"learning",self.vishvakarma)
        self.design=SudarshanDesignEngine(self.root/"design",knowledge=self.vishvakarma)
