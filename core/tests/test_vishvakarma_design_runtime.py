...
from krishna_core.sudarshan_design_engine import (
    AcceptanceGovernor, DesignDrift, DesignJob, SudarshanDesignEngine,
)
...
class VishvakarmaDesignRuntimeTests(unittest.TestCase):
    def test_vishvakarma_is_a_real_council_profile_with_modern_role_boundary(self):
    ...
    def test_design_engine_drift_acceptance_and_repair_loop(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertIn("Playwright",CURRICULUM)
