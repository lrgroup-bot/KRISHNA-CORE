...
class WebValidationTests(unittest.TestCase):
    ...
    def test_command_center_v4_contract(self):
        ...
        for token in (
            ...
            "startGarudanetraMission", "actionReq('garuda.scout'", "loadGarudanetra",
            "actionReq('garudanetra.start'", "actionReq('garudanetra.control'", "actionReq('garudanetra.upload_attachment'", "/api/garudanetra/frame",
            ...
            "/api/models/gateways/register", "gatewayFreeOnly", "Windows DPAPI", "projectRegRole",
            "/api/mobile/pair/pending", "approveMobilePairing", "Zero-code request",
